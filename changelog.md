...
### Fixed
- Table stickers filling kill itself correctly at end

### Removed
- Docs about depracated email sending (gmail)

### Changed
- Heroku stack upgraded to 22
...
## [1.0.8] - 2022-06-25
### Added
- Documentation about produciont database restarting
...
## [1.0.4] - 2022-06-20
### Added
- Documentation about development environment
...
## [1.0.3] - 2022-06-20
### Changed
- Update package-lock to verion 2
...
## [1.0.2] - 2021-03-15
### Fixed
- Returns the value 0 to contribution total, when there is no contribution yet
...
### Fixed
- Avoids comum users get stickers account
...
## [0.30.6] - 2021-03-12
### Changed
- Adjusts the SSL param to Postgres connection
...
## [0.30.5] - 2021-03-12
### Added
- Adds SSL param to Postgres connection
...
## [0.30.2] - 2021-03-07
### Added
- Retrieves people profile data

### Removed
- Retrieves people table data
...
## [0.26.1] - 2021-02-15
### Fixed
- Avoids low-balance users request stickers
